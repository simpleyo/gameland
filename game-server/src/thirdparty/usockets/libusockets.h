...
// Ejecuta el loop solo una vez. 
// <first_iteration> debe ser distinto de cero la primera vez que se llame a us_loop_once. En todas las demas llamadas debe ser cero.
WIN32_EXPORT void us_loop_once(struct us_loop_t *loop, int first_iteration);

// Indica si el loop esta alive.
WIN32_EXPORT int us_loop_alive(const struct us_loop_t *loop);
